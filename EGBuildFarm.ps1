...
{ 
    ...
    Node TeamCity
    {
        File TeamCity
        {
            ...
            Ensure = "Present"
            SourcePath = "\\prodevgcoresoftwareape.file.core.windows.net\software\Software\TeamCity\TeamCity-10.0.2.exe"
            Type = "File"
            Recurse = $false
        }
        ...
        File sqljdbc
        {
            ...
            Credential = $storageCredential
            Ensure = "Present"
            SourcePath = "\\prodevgcoresoftwareape.file.core.windows.net\software\Software\TeamCity\sqljdbc_4.2.6420.100_enu.exe.lnk"
            Type = "File"
            Recurse = $false
        }
